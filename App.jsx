        ...
        {tab==='alistamiento'&&(
          <div style={{display:'flex',flexDirection:'column',gap}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:col5,gap:10}}>
              ...
              <KPI label="Tiempo Prom (Min)" value={`${tiempoPromedio} Min`} accent={C.blue} />
            </div>
          ...
          <div style={{display:'flex',flexDirection:'column',gap}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:isMobile?'1fr 1fr':'repeat(5,1fr)',gap:10}}>
              ...
              <KPI label="Registro Tardío" value={fmt(kpiTraz.tardio)}
                ...
                desc="Existe trazabilidad completa entre alistamiento e instalación, pero el alistamiento fue registrado después de la instalación" />
            </div>
